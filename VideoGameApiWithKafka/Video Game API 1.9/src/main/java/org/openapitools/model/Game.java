...
public class Game implements UserGamesInner {
  ...
  */
  ...
  @Schema(name = "pubishYear", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("pubishYear")
  ...
  */
  @NotNull 
  @Schema(name = "console", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  ...
  @Schema(name = "numOwners", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
